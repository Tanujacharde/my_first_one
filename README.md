...
<body class="bg-gray-100"> <!-- Header -->
    ...
    <main class="container mx-auto p-6"> <!-- Profile Section -->
        <section id="about" class="bg-white rounded-xl shadow-lg p-8 flex flex-col md:flex-row gap-8 items-center">
            <!-- Student Photo -->
            <article> <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRi7HRaQowJqGd2eTSrYuaj9rX26s9LOoukaqEOzwMInxYhjf0-LkWf4mqK&s=10”                     alt=" Student Photo"
                    class="w-64 h-64 rounded-full border-8 border-blue-600 object-cover"> </article>
            <!-- Student Details -->
            <article class="flex-1">
                <h2 class="text-3xl font-bold text-blue-700 mb-4"> Tanuja Charde </h2>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
                    <div>
                        ...
                        <p><strong>Date of Birth :</strong>15/09/2007 </p>
                    </div>
                    <div>
                ...
                <table class="w-full border border-gray-300">
                    ...
                    <tbody>
                        ...
                        <tr class="text-center hover:bg-gray-100">
                            ...
                            <td class="border p-3">7.78 CGPA</td>
                        </tr>
                    </tbody>
                </table>
            </div>
